...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                        ...
                                        <tr>
                                            <td align="center">
                                                <telerik:RadGrid ID="gvTaskGroup" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                    ...
                                                    BorderStyle="None" Skin="WebBlue" DataSourceID="sqlDSExchangeTask" 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <telerik:RadComboBox ID="ddlUsuarioTask_Edit" runat="server" Width="300px" DataTextField="sCompleteName"
                                                                DataValueField="fiid_employed" DataSourceID="sqlEmployedByTask" 
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" colspan="2">
                                                <telerik:RadGrid ID="gvTaskData" runat="server" CellPadding="4" AllowPaging="True"
                                                    ...
                                                    DataSourceID="sqlDSDataTaskbyTaskId" GridLines="None" Skin="WebBlue">
                                                    <ClientSettings AllowColumnsReorder="True" ReorderColumnsOnClient="True">
                                                        <Selecting AllowRowSelect="True" />
                                                    </ClientSettings>
                                                    <AlternatingItemStyle Font-Names="Verdana" Font-Size="X-Small" />
                                ...
                                <telerik:RadPageView ID="RadPageView2" runat="server">
                                        ...
                                        <tr>
                                            <td align="center">
                                                <telerik:RadGrid ID="gvTaskGroupA" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ...
                                                    Culture="es-MX" Skin="WebBlue" OnItemCommand="gvTaskGroup_ItemCommand" BorderStyle="None"
                                                    CellSpacing="0">
                                                    <ClientSettings AllowColumnsReorder="True" ReorderColumnsOnClient="True">
                                                        <Selecting AllowRowSelect="True" />
                                                    </ClientSettings>
                                    ...
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <telerik:RadTextBox Skin="WebBlue" ID="txtReviewExchangeObs" runat="server" Height="60px"
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <telerik:RadGrid ID="gvReviewTask" runat="server" CellPadding="4" AllowPaging="True"
                                                    AllowSorting="True" AutoGenerateColumns="False" CellSpacing="0" DataKeyNames="iIdTaskData"
                                                    DataSourceID="sqlDSTaskAutorization" Skin="WebBlue">
                                                    <ClientSettings AllowColumnsReorder="True" ReorderColumnsOnClient="True">
                                                        <Selecting AllowRowSelect="True" />
                                                    </ClientSettings>
                                                    <AlternatingItemStyle Font-Names="Verdana" Font-Size="X-Small" />
    ...
    <asp:SqlDataSource ID="sqlDStaskGroupByGroup" runat="server" ConnectionString="<%$ ConnectionStrings:SACIConnectionString %>"
    ...
    <asp:SqlDataSource ID="sqlDSTaskAutorization" runat="server" ConnectionString="<%$ ConnectionStrings:SACIConnectionString %>"
    ...
    <asp:SqlDataSource ID="sqlDSDataTaskbyTaskId" runat="server" ConnectionString="<%$ ConnectionStrings:SACIConnectionString %>"
    ...
    <asp:SqlDataSource ID="sqlEmployedByTask" runat="server" ConnectionString="<%$ ConnectionStrings:SACIConnectionString %>"
