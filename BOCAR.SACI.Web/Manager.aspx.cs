...
public partial class Manager : System.Web.UI.Page
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		{
			if (!Page.IsPostBack)
				util.LoadMenu("Security.aspx", BOCAR.SACI.Business.SecurityManager.ObtenerUsuario(HttpContext.Current).IdRol, ref menuSecurity);
		}
	...
	{
		string action = util.GetActionMenu(menuSecurity.SelectedItem.Value, false);
