                                    ...
                                    <tr>
                                        <td width="80%" align="center">
                                            <telerik:RadGrid ID="gvExchange" runat="server" CellPadding="4" AllowPaging="True"
                                                DataKeyNames="fiid_Exchange" DataSourceID="sqlDS" AllowSorting="True" AutoGenerateColumns="False"
                                                Font-Size="XX-Small" CellSpacing="0" GridLines="None" Skin="WebBlue">
                                ...
                                <telerik:RadPageView ID="pnExchange" runat="server">
                                    <table style="vertical-align: top; text-align: left; border-style: none" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <telerik:RadTextBox ID="txtLastFolio" runat="server" MaxLength="20" Skin="WebBlue"
                                                    Width="150px">
                                                </telerik:RadTextBox>
                                            </td>
                                        </tr>
                                    ...
                                    <table style="line-height: 10px; vertical-align: top; text-align: left; border-style: none"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <telerik:RadTextBox ID="txtProyectPlataformDescription" runat="server" EmptyMessage="F25, X11, JC$9, L42"
                                                    MaxLength="50" Skin="WebBlue" Width="250px">
                                                </telerik:RadTextBox>
                                            </td>
                                        </tr>
                                        <tr valign="top">
                                            ...
                                            <td valign="top">
                                                <telerik:RadTextBox ID="txtDescription" runat="server" EmptyMessage="Nombre de pieza"
                                                    MaxLength="250" Skin="WebBlue" TextMode="MultiLine" Width="90%">
                                                </telerik:RadTextBox>
                                            </td>
                                        </tr>
                                        <tr valign="top">
                                            ...
                                            <td>
                                                <telerik:RadTextBox ID="txtIssue" runat="server" MaxLength="250" Skin="WebBlue" TextMode="MultiLine"
                                                    Width="90%">
                                                </telerik:RadTextBox>
                                            </td>
                                        </tr>
                                        <tr valign="top">
                                            ...
                                            <td>
                                                <telerik:RadTextBox ID="txtReason" runat="server" MaxLength="250" Skin="WebBlue"
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td>
                                                <telerik:RadTextBox ID="txtAction" runat="server" MaxLength="250" Skin="WebBlue"
                                                    TextMode="MultiLine" Width="90%">
                                                </telerik:RadTextBox>
                                            </td>
                                        </tr>
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td>
                                                <telerik:RadTextBox ID="txtContact" runat="server" Skin="WebBlue" Width="90%">
                                                </telerik:RadTextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <telerik:RadGrid ID="gvTimming" runat="server" AllowPaging="True" AllowSorting="True"
                                                    ...
                                                    Font-Size="XX-Small" GridLines="None" Skin="WebBlue">
                                                    <ClientSettings AllowColumnsReorder="True" ReorderColumnsOnClient="True">
                                                        <Selecting AllowRowSelect="True" />
                                                    </ClientSettings>
                                                    <AlternatingItemStyle Font-Names="Verdana" Font-Size="X-Small" />
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderText="">
                                                                <ItemTemplate>
                                                                    <asp:ImageButton ID="imbSelectReviewExchange" runat="server" CausesValidation="false"
                                                                        ...
                                                                        OnClick="imbSelectReviewExchange_Click1" Style="height: 16px" Text="Botón" ToolTip="Modificar registro" />
                                                                </ItemTemplate>
                                                ...
                                                <td>
                                                    <table width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" valign="top">
                                                                <telerik:RadTextBox ID="txtTimingEnd" runat="server" Skin="WebBlue">
                                                                </telerik:RadTextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <td>
                                                    <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <telerik:RadTextBox ID="txtPound" runat="server" Skin="WebBlue">
                                                                </telerik:RadTextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <telerik:RadTextBox ID="txtDelta" runat="server" Skin="WebBlue">
                                                                </telerik:RadTextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <telerik:RadTextBox ID="txtCostC" runat="server" Skin="WebBlue">
                                                                </telerik:RadTextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <telerik:RadTextBox ID="txtSOP" runat="server" ForeColor="Red" Skin="WebBlue">
                                                                </telerik:RadTextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <telerik:RadTextBox ID="txtCostM" runat="server" Skin="WebBlue">
                                                                </telerik:RadTextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <telerik:RadTextBox ID="txtMoldC" runat="server" Skin="WebBlue">
                                                                </telerik:RadTextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <telerik:RadTextBox ID="txtProt" runat="server" Skin="WebBlue">
                                                                </telerik:RadTextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td valign="top">
                                                    <table width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <telerik:RadTextBox ID="txtDateStart" runat="server" Skin="WebBlue">
                                                                </telerik:RadTextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    ...
                                                    <telerik:RadGrid ID="gvCost" runat="server" AllowPaging="True" AllowSorting="True"
                                                        AutoGenerateColumns="False" CellPadding="4" CellSpacing="0" DataKeyNames="iIdPartListExchange"
                                                        DataSourceID="sqlDSPArtLisExCost" GridLines="None" Skin="WebBlue">
                                                        <ClientSettings AllowColumnsReorder="True" ReorderColumnsOnClient="True">
                                                            <Selecting AllowRowSelect="True" />
                                                        </ClientSettings>
                                                        <MasterTableView>
                                                    ...
                                                    <asp:Panel ID="AffectationPartList" runat="server" Visible="False">
                                                        <table width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <telerik:RadTextBox ID="txtCostAdd" runat="server" Skin="WebBlue">
                                                                    </telerik:RadTextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <telerik:RadGrid ID="gvDocuments" runat="server" AllowPaging="True" AllowSorting="True"
                                                    AutoGenerateColumns="False" CellPadding="4" CellSpacing="0" DataKeyNames="iIdExchangeFile"
                                                    DataSourceID="sqlDSExchangeFile" GridLines="None" OnItemCommand="gvDocuments_ItemCommand"
                                                    Skin="WebBlue">
                                                    <ClientSettings AllowColumnsReorder="True" ReorderColumnsOnClient="True">
                                                        <Selecting AllowRowSelect="True" />
                                                    </ClientSettings>
                                                            ...
                                                            <telerik:GridTemplateColumn HeaderText="" UniqueName="TemplateColumn">
                                                                <ItemTemplate>
                                                                    <asp:Panel ID="Panel1" runat="server">
                                                                        <asp:ImageButton ID="rbtnSelect" runat="server" AutoPostBack="true" CommandName="Download"
                                                                            Height="23" ImageUrl="~/img/msg-refresh.jpg" Width="23" />
                                                                    </asp:Panel>
                                                                </ItemTemplate>
                                                            </telerik:GridTemplateColumn>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="50%">
                                                            <telerik:RadAsyncUpload ID="RadAsyncUpload1" runat="server" AutoAddFileInputs="False"
                                                                Culture="es-MX" Skin="WebBlue" Width="280px">
