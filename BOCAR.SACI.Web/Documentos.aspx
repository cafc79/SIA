...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <tr>
            <td style="vertical-align: top; text-align: left; border-right-style: groove; border-right-width: 2px;"
                ...
                <asp:Menu ID="menuReporte" runat="server" BackColor="#B5C7DE" Font-Names="Verdana"
                    ...
                    OnMenuItemClick="menuReporte_MenuItemClick">
                                ...
                                <tr>
                                    <td>
                                        <table style="vertical-align: top; border-style: none" width="100%">
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <telerik:RadButton ID="btnDocumentos" runat="server" Skin="Web20" 
                                                        Text="Busqueda" onclick="btnDocumentos_Click">
                                                    </telerik:RadButton>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td>
                                        <telerik:RadGrid ID="gvRequerimientos" runat="server" AllowPaging="True" AllowSorting="True"
                                            ...
                                            onitemcommand="gvRequerimientos_ItemCommand">
                                            <ClientSettings>
                                                <Selecting AllowRowSelect="True" />
                                            </ClientSettings>
                                            <AlternatingItemStyle Font-Names="Verdana" Font-Size="X-Small" />
                                                    ...
                                                    <telerik:GridTemplateColumn UniqueName="TemplateColumn" HeaderText="">
                                                        <ItemTemplate>
                                                            <asp:Panel ID="Panel1" runat="server">
                                                                <asp:ImageButton ID="rbtnSelect" runat="server" AutoPostBack="true" ImageUrl="~/img/msg-refresh.jpg" CommandName="Download" />
                                                            </asp:Panel>
                                                        </ItemTemplate>
                                                    </telerik:GridTemplateColumn>
    ...
    <asp:SqlDataSource ID="sqlDSExchange" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="txtPreFolio" Name="fvPrefolio" PropertyName="Text" Type="string" />
