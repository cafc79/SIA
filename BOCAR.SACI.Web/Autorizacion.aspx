...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                            ...
                                            <td>
                                                <table style="width: 100%;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <telerik:RadTextBox Skin="WebBlue" ID="txtObsEngProduct" runat="server" Height="73px"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <telerik:RadTextBox Skin="WebBlue" ID="txtObsEngManager" runat="server" Height="73px"
                                                                TextMode="MultiLine" Width="328px">
                                                            </telerik:RadTextBox>
                                                        </td>
                                                    </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <telerik:RadGrid ID="gvExchangeReview" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        AllowSorting="True" Culture="es-MX" Skin="WebBlue">
                                            ...
                                            <td>
                                                <table style="width: 100%;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <telerik:RadTextBox Skin="WebBlue" ID="txtSalesAutorization" runat="server" Height="60px"
                                                                TextMode="MultiLine" Width="90%">
                                                            </telerik:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <telerik:RadButton Skin="Windows7" ID="btnSalesCancelar" runat="server" 
                                                                Text="Cancelar" onclick="btnSalesCancelar_Click" />
                                                            <telerik:RadButton Skin="Windows7" ID="btnSalesAceptar" runat="server" 
                                                                Text="Aceptar" onclick="btnSalesAceptar_Click" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
    ...
    <asp:SqlDataSource ID="sqlDSReviewTypeExchange" runat="server" ConnectionString="<%$ ConnectionStrings:SACIConnectionString %>"
		...
		<asp:SqlDataSource ID="sqlDSReviewType" runat="server" 
			ConnectionString="<%$ ConnectionStrings:SACIConnectionString %>" 
			SelectCommand="sp_selectReviewType" SelectCommandType="StoredProcedure">
		</asp:SqlDataSource>
