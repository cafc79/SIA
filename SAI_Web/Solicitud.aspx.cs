...
public partial class Solicitud : System.Web.UI.Page
{
		...
		try
		{
			if (!Page.IsPostBack)
			{
				...
				if (Request.QueryString["mod"] != null && Request.QueryString["ex"] != null)
				{
					...
					wndRequerimiento.NavigateUrl = "Mobile/Requerimiento.aspx?ex=" + Request.QueryString["ex"] + "&mod=" + Master.Page.Request.Url.Segments[Master.Page.Request.Url.Segments.Length - 1];
	...
	protected void imbSelectExchange_Click(object sender, ImageClickEventArgs e)
	{
		...
		selectedExchange(iIdExchange);
		wndRequerimiento.NavigateUrl = "Mobile/Requerimiento.aspx?ex=" + iIdExchange + "&mod=" + Master.Page.Request.Url.Segments[Master.Page.Request.Url.Segments.Length - 1];
