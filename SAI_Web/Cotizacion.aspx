        ...
        <tr>
            <td>
                <asp:Panel ID="pnQuoteA" runat="server">
                    <table style="border-style: solid; border-width: thin; width: 100%; vertical-align: top;
                        text-align: left;">
                        <tr>
                            <td width="5%">
                            </td>
                                        ...
                                        <td width="35%" valign="top">
                                            <table width="100%" style="border-width: 0px;">
                                                <tr>
                                                    ...
                                                    <td width="160px">
                                                        <telerik:RadTextBox ID="txtDateIn" runat="server" Enabled="false">
                                                        </telerik:RadTextBox><asp:ImageButton ID="imbDateIn" runat="server" ImageUrl="Img/calendar.png"
                                                            OnClick="imbDateIn_Click" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <telerik:RadTextBox ID="txtDateProm" runat="server" Enabled="false">
                                                        </telerik:RadTextBox><asp:ImageButton ID="imbDateProm" runat="server" ImageUrl="Img/calendar.png"
                                                            OnClick="imbDateProm_Click" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <telerik:RadTextBox ID="txtDateOut" runat="server" Enabled="false">
                                                        </telerik:RadTextBox><asp:ImageButton ID="imbDateOut" runat="server" ImageUrl="Img/calendar.png"
                                                            OnClick="imbDateOut_Click" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <telerik:RadTextBox ID="txtSOPClientC" runat="server" ForeColor="Red">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <td>
                                            <table width="100%" style="border-width: 0px; font-size: xx-small;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <telerik:RadTextBox ID="txtMoldC" runat="server" Font-Size="XX-Small" Width="100px"
                                                            Visible="False">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                    <td width="120px">
                                                    ...
                                                    <td>
                                                        ...
                                                        <telerik:RadTextBox ID="txtComponentsC" runat="server" Font-Size="XX-Small" Width="100px">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                    <td width="70px">
                                                    ...
                                                    <td>
                                                        <telerik:RadTextBox ID="txtPoundC" runat="server" Font-Size="XX-Small" Width="50px">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                    <td>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <telerik:RadTextBox ID="txtMoldSC" runat="server" Font-Size="XX-Small" Width="100px"
                                                            Visible="False">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                    <td>
                                                        <telerik:RadTextBox ID="txtOthersTitleWC" runat="server" Font-Size="XX-Small" Width="100px">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                    <td bgcolor="#FF3300">
                                                        <asp:CheckBox ID="chkOthersWC" runat="server" OnCheckedChanged="CheckCotizacion_CheckedChanged"
                                                            AutoPostBack="True" />
                                                    </td>
                                                    <td>
                                                        <asp:Label ID="Label77" runat="server" Text="$"></asp:Label>
                                                        <telerik:RadTextBox ID="txtOthersWC" runat="server" Font-Size="XX-Small" Width="100px"
                                                            Visible="False">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <telerik:RadNumericTextBox ID="txtDelta1" runat="server" Font-Size="XX-Small" Width="50px"
                                                            Culture="es-MX" Value="0" OnTextChanged="txtCalculoCosto_TextChanged" Skin="Transparent"
                                                            AutoPostBack="True">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <telerik:RadTextBox ID="txtCFC" runat="server" Font-Size="XX-Small" Width="100px"
                                                            Visible="False">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <telerik:RadTextBox ID="txtPaintC" runat="server" Font-Size="XX-Small" Width="100px"
                                                            Visible="False">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <telerik:RadNumericTextBox ID="txtDelta2" runat="server" Font-Size="XX-Small" Width="50px"
                                                            Culture="es-MX" OnTextChanged="txtCalculoCosto_TextChanged" Skin="Transparent" Value="0"
                                                            AutoPostBack="True">
                                                        </telerik:RadNumericTextBox>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <telerik:RadTextBox ID="txtDeviceC" runat="server" Font-Size="XX-Small" Width="100px"
                                                            Visible="False">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <telerik:RadTextBox ID="txtEmpC" runat="server" Font-Size="XX-Small" Width="100px"
                                                            Visible="False">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <telerik:RadNumericTextBox ID="txtCost" runat="server" Font-Size="XX-Small" Width="50px"
                                                            Culture="es-MX" Skin="Transparent" Value="0" ReadOnly="True" DataType="System.Decimal">
                                                        </telerik:RadNumericTextBox>
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <telerik:RadNumericTextBox ID="txtR1" runat="server" Font-Size="XX-Small" Width="50px"
                                                            Culture="es-MX" OnTextChanged="txtCalculoCosto_TextChanged" Skin="Transparent" Value="0"
                                                            AutoPostBack="True">
                                                        </telerik:RadNumericTextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <telerik:RadTextBox ID="txtObsoletC" runat="server" Font-Size="XX-Small" Width="100px"
                                                            Visible="False">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <telerik:RadTextBox ID="txtBankC" runat="server" Font-Size="XX-Small" Width="100px"
                                                            Visible="False">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <telerik:RadNumericTextBox ID="txtR2" runat="server" Font-Size="XX-Small" Width="50px"
                                                            Culture="es-MX" OnTextChanged="txtCalculoCosto_TextChanged" Skin="Transparent" Value="0"
                                                            AutoPostBack="True">
                                                        </telerik:RadNumericTextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <telerik:RadTextBox ID="txtManEngC" runat="server" Font-Size="XX-Small" Width="100px"
                                                            Visible="False">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <telerik:RadTextBox ID="txtDesignC" runat="server" Font-Size="XX-Small" Width="100px"
                                                            Visible="False">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <telerik:RadTextBox ID="txtPrue" runat="server" Font-Size="XX-Small" Width="100px">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                    <td>
                                                    </td>
                                            ...
                                            <table width="100%" style="border-style: 0; border-color: 0; border-width: 0px; font-size: xx-small;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <telerik:RadTextBox ID="txtMoldPlazoC" runat="server" Font-Size="XX-Small" Width="100px">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <telerik:RadTextBox ID="txtMoldProtC" runat="server" Font-Size="XX-Small" Width="100px">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <telerik:RadTextBox ID="txtDateStart" runat="server" Font-Size="XX-Small" Width="100px">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                    <td width="120px">
                                            ...
                                            <table style="border-style: 0; border-color: 0; border-width: 0px; font-size: xx-small;"
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="80%">
                                                        <telerik:RadTextBox ID="txtObsC" runat="server" Font-Size="XX-Small" Width="90%"
                                                            ForeColor="#000066" TextMode="MultiLine">
                                                        </telerik:RadTextBox>
                                                    </td>
                                                    <td>
                                                    </td>
                                            ...
                                            <table style="border-style: 0; border-color: 0; border-width: 0px; font-size: xx-small;"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        ...
                                                        <telerik:RadButton Skin="Windows7" ID="btnUpdateQuote" runat="server" Text="Modificar"
                                                            OnClick="btnUpdateQuote_Click" Visible="False" />
                                                        <telerik:RadButton Skin="Windows7" ID="btnAddQuote" runat="server" OnClick="btnAddQuote_Click"
                                                            Text="Agregar" />
                                                    </td>
                                                    <td width="10%">
                                                    </td>
