...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" EnablePageHeadUpdate="False">
        <ajaxsettings>
            <telerik:AjaxSetting AjaxControlID="comboModulo">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="gvPagina" LoadingPanelID="RadAjaxLoadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
                ...
                <telerik:RadMultiPage ID="MultiPage_Seguridad" runat="server" RenderSelectedPageOnly="True">
                                        ...
                                        <tr>
                                            <td width="50%" align="center">
                                                <telerik:RadGrid ID='gvRol' runat="server" AllowPaging="True" AllowSorting="True"
                                                    AutoGenerateColumns="False" CellSpacing="0" GridLines="None" Skin="Transparent" DataSourceID="sqlDSRol"
                                                    OnItemCommand="gvRol_ItemCommand" Width="350px" OnPageIndexChanged="gvRol_PageIndexChanged">
                                                    <ClientSettings>
                                                ...
                                                <div align="left" style="width: 100%;">
                                                    ...
                                                    <div>
                                                        <telerik:RadGrid ID="gvPagina" runat="server" AllowPaging="True" AllowSorting="True"
                                                            AutoGenerateColumns="False" CellSpacing="0" GridLines="Horizontal" Skin="Transparent"
                    ...
                    <telerik:RadPageView ID="pnUser" runat="server">
                        <telerik:RadGrid ID="gvUsers" runat="server" AllowFilteringByColumn="True" AllowPaging="True"
                            ...
                            ShowGroupPanel="True" Skin="Transparent" OnItemCommand="gvUsers_ItemCommand" Style="margin-top: 0px"
    ...
    <asp:SqlDataSource ID="sqlDSRol" runat="server" ConnectionString="<%$ ConnectionStrings:SAIConnectionString %>"
