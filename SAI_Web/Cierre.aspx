...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
                ...
                <tr>
                    ...
                    <td align="center">
                        <telerik:RadGrid ID="gridFolio" runat="server" AllowPaging="True" CellSpacing="0"
                            DataSourceID="sqlDS_Folio" OnItemCommand="gridFolio_ItemCommand" GridLines="None"
                            Skin="Transparent" AutoGenerateColumns="False">
                            <ClientSettings>
                        ...
                        <asp:Panel ID="PanelEstatus" runat="server" Visible="false">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadTextBox ID="txtFecha" runat="server" Skin="Transparent" Visible="false" Width="280px">
                                        </telerik:RadTextBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadTextBox ID="txtObservacion" runat="server" Skin="Transparent" Width="280px">
                                        </telerik:RadTextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadNumericTextBox ID="txtCostoReal" runat="server" Skin="Transparent" Width="280px">
                        ...
                        <asp:Panel ID="PanelDocumentos" runat="server" Visible="false">
                            <table>
                                <tr style="visibility: hidden">
                                    ...
                                    <td>
                                        <telerik:RadTextBox ID="txtFechaLiberacion" runat="server" Skin="Transparent" Width="280px"
                                            ReadOnly="true">
                                        </telerik:RadTextBox>
                                    </td>
                                </tr>
                                <tr style="visibility: hidden">
                                    ...
                                    <td>
                                        <telerik:RadTextBox ID="txtEstatus" runat="server" Skin="Transparent" Width="280px" ReadOnly="true">
                                        </telerik:RadTextBox>
                                    </td>
                                </tr>
                                <tr>
        ...
        <asp:SqlDataSource ID="sqlDS_Folio" runat="server" ConnectionString="<%$ ConnectionStrings:SAIConnectionString %>"
        ...
        <asp:SqlDataSource ID="sqlDSEstatus" runat="server" ConnectionString="<%$ ConnectionStrings:SAIConnectionString %>"
