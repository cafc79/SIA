                        ...
                        <tr>
                            ...
                            <td width="260px">
                                <telerik:RadTextBox Skin="Transparent" ID="txtSrchPreFol" runat="server" Width="250px"
                                    EmptyMessage="Busqueda de Prefolio">
                                </telerik:RadTextBox>
                            </td>
                        ...
                        <tr>
                            <td align="center">
                                <telerik:RadGrid ID="gvExchange" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    AllowSorting="True" CellSpacing="0" Skin="Transparent" Culture="es-MX">
                    ...
                    <telerik:RadPageView ID="pnExchange" runat="server">
                        <table width="100%" style="vertical-align: top; text-align: left; border-style: none">
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadTextBox Skin="Transparent" ID="txtLastFolio" runat="server" MaxLength="20"
                        ...
                        <table width="100%" style="line-height: 10px; vertical-align: top; text-align: left;
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadTextBox Skin="Transparent" ID="txtProyectPlataformDescription" runat="server"
                            ...
                            <tr valign="top">
                                ...
                                <td valign="top">
                                    <telerik:RadTextBox Skin="Transparent" ID="txtDescription" runat="server" MaxLength="250"
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    <telerik:RadTextBox Skin="Transparent" ID="txtIssue" runat="server" MaxLength="250" TextMode="MultiLine"
                                        Width="90%">
                                    </telerik:RadTextBox>
                                </td>
                            </tr>
                            <tr valign="top">
                                ...
                                <td>
                                    <telerik:RadTextBox Skin="Transparent" ID="txtReason" runat="server" MaxLength="250"
                                        TextMode="MultiLine" Width="90%">
                                    </telerik:RadTextBox>
                                </td>
                            </tr>
                            <tr valign="top">
                                ...
                                <td>
                                    <telerik:RadTextBox Skin="Transparent" ID="txtAction" runat="server" MaxLength="250"
                                        TextMode="MultiLine" Width="90%">
                                    </telerik:RadTextBox>
                                </td>
                            </tr>
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    <telerik:RadTextBox Skin="Transparent" ID="txtContact" runat="server" Width="90%">
                                    </telerik:RadTextBox>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align="left">
                                    <telerik:RadGrid ID="gvDocuments" runat="server" CellPadding="4" AllowPaging="True"
                                        ...
                                        DataSourceID="sqlDSExchangeFile" GridLines="None" Skin="Transparent" 
