                                ...
                                <telerik:RadGrid ID="gvPartListExchange" runat="server" AllowPaging="True" AllowSorting="True"
                                    ...
                                    <MasterTableView DataSourceID="sqlDSPartListExchange">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="sPartListDS" HeaderText="No. Parte DS" ReadOnly="true">
                                            </telerik:GridBoundColumn>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <telerik:RadComboBox ID="ddlPartListExchangePartList" runat="server" DataSourceID="sqlDSddlPartList"
                                                            ...
                                                            EnableVirtualScrolling="True" Skin="Vista" OpenDropDownOnLoad="True" AllowCustomText="True"
                                                            MarkFirstMatch="True">
                                                        </telerik:RadComboBox>
                                                    </td>
                                                </tr>
                                            ...
                                            <asp:Panel ID="pnPartListAdd" runat="server" Visible="False">
                                                <table style="width: 100%;">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <telerik:RadTextBox Skin="Transparent" ID="txtDescriptionPartList" runat="server" MaxLength="50"
                                                                Width="90%">
                                                            </telerik:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <telerik:RadTextBox Skin="Transparent" ID="txtNumberPartList" runat="server" MaxLength="20"
                                                                Width="200px">
                                                            </telerik:RadTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <telerik:RadTextBox Skin="Transparent" ID="txtNumberPartListClient" runat="server" MaxLength="20"
                                                                Width="200px">
                                                            </telerik:RadTextBox>
                                                        </td>
                                                    </tr>
